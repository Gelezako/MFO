                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5 sm-margin-b-30">
                            ...
                            <h2 class="color-white">Поиск банка по МФО</h2>
                                ...
                                <option value="Агриколь">КРЕДИ АГРИКОЛЬ</option>
                                <option value="Открытие">Банк "ФК Открытие"</option>
                                <option value="Россельхозбанк">Россельхозбанк</option>
                                <option value="Промсвязьбанк">Промсвязьбанк</option>
                                <option value="МОСКОВСКИЙ КРЕДИТНЫЙ БАНК">МОСКОВСКИЙ КРЕДИТНЫЙ БАНК</option>
                                ...
                                <option value="МБМ-БАНК">МБМ-БАНК</option>
                                <option value="АК БАРС">АК БАРС</option>
                                <option value="ПроКредит">ПроКредит БАНК</option>
                                <option value="ЕВРОСИТИБАНК">ЕВРОСИТИБАНК</option>
                                <option value="ПРОМЭКСИМБАНК">ПРОМЭКСИМБАНК</option>
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter839118 = new Ya.Metrika({
                    id:839118,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/839118" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
    <!-- END BODY -->
</html>
